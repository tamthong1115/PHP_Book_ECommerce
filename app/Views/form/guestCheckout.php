...
<div class="guest-order-container">
    <form class="guest-order-form">
        ...
        <input type="text" id="guest_phone_number" name="guest_phone_number" placeholder="Phone Number">
        <div class="error-message" id="guest_phone_numberError"></div>

        <input type="text" id="guest_address_line_1" name="guest_address_line_1" placeholder="Address Line 1">
        <div class="error-message" id="guest_address_line_1Error"></div>

        <input type="text" id="guest_address_line_2" name="guest_address_line_2" placeholder="Address Line 2 (Optional)">
